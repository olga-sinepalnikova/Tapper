...
func newChat(db *gorm.DB, opts ...gen.DOOption) chat {
	...
	_chat.User1ID = field.NewInt32(tableName, "user1_id")
	_chat.User2ID = field.NewInt32(tableName, "user2_id")
...
func (c *chat) updateTableName(table string) *chat {
	...
	c.User1ID = field.NewInt32(table, "user1_id")
	c.User2ID = field.NewInt32(table, "user2_id")
